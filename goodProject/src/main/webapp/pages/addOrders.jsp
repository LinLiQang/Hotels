...
<head>
	...
	<script>
		$(function(){
			$("#sub").click(function(){
				$.post("${pageContext.request.contextPath}/orders/add",$("form").serialize(),function(data){
					if(data.flag){
						alert(data.msg);
			...
			<section class="content">
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">房间ID</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="房间ID" value="" name="rid">
						</div>

						<div class="col-md-2 title">用户ID</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="用户ID" value="" name="uid">
						</div>

						<div class="col-md-2 title">订单价格</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="订单价格" value="" name="ordersPrice">
						</div>
