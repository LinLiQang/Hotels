...
<body class="hold-transition skin-purple sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <img src="<%--${pageContext.request.contextPath}/RoomImage/--%>${pageContext.request.contextPath}/${roomImg.secondImg}">
            <img src="<%--${pageContext.request.contextPath}/RoomImage/--%>${pageContext.request.contextPath}/${roomImg.thirdImg}">
