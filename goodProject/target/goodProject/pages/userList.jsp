                        ...
                        <div class="table-box">
                                ...
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default" title="刷新"
                                                onclick="location.href='${pageContext.request.contextPath}/user/findAll?page=${pageInfo.pageNum}&size=${pageInfo.pageSize}'">
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                ...
                                <c:forEach items="${pageInfo.list}" var="user">
                                    <tr>
                                        <td><input name="checkId" value="${user.uid}" type="checkbox"></td>
                                        <td class="text-center">${user.uid}</td>
                                        <td class="text-center">${user.username}</td>
                                        <td class="text-center">${user.name}</td>
                                        <td class="text-center">${user.sex}</td>
                                        <td class="text-center">${user.tel}</td>
                                        <td class="text-center">${user.userStatusStr}</td>
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/user/findByUid?uid='+${user.uid}">详情</button>
                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/user/beforeUpdateUser?id='+${user.uid}">编辑</button>
                                            <button type="button" class="btn bg-olive btn-xs" onclick="deleteUser(${user.uid})">删除</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
    ...
    <script>
        ...
        function deleteSelect(){
            ...
            if(ids != '' && ids != null){
                ...
                if(an){
                    $.post("${pageContext.request.contextPath}/user/deleteSelect",{'ids':ids},function(data){
                        if(data.flag){
                            alert(data.msg);
